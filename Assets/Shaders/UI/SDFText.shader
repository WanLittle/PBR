Shader "My/UI/SDFText"
{
	Properties
	{
		...
		_DistanceMark("Distance Mark", float) = 0.5
		_SmoothDelta("Smooth Delta", float) = 0.05

		_OutlineDistanceMark("Outline Distance Mark", float) = 0.1
		_OutlineColor("Outline Color", Color) = (1,0,0,1)

		_GlowDistanceMark("Glow Distance Mark", float) = 0.25
		_GlowSmoothDelta("Glow Smooth", float) = 0.1
		_MainColor("Main Color", Color) = (1,1,1,1)
		_GlowColor("Glow Color", Color) = (1,0,0,1)

		_ShadowSmoothDelta("Shadow Smooth", float) = 0.1
		_ShadowColor("Shadow Color", Color) = (0.1, 0.1, 0.1,1)
		_ShadowOffsetX("Shadow Offset X", float) = -0.05
		_ShadowOffsetY("Shadow Offset Y", float) = 0.05
	}
